class Form {
   ...
   //this.myDiv = createDiv('Welcome to Go News!');
    ...
    display(){
      this.greeting.html('Hi'  + displayname.value());
      this.greeting.position(300,300);
      this.greeting.style('color',"yellow");
    
      this.greeting2.html('Dear'+ displayname.value() + ' , this app is about our environment and  Global Warming and also about nearby Environmental updates  ');
